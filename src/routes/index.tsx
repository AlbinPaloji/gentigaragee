    ...
    <header className={`fixed inset-x-0 top-0 z-50 border-b border-border bg-background/90 backdrop-blur-xl transition-all ${scrolled ? "py-0" : "py-2"}`}>
      <div className="mx-auto flex max-w-[1400px] items-center justify-between px-5 py-2">
        <a href="#home" aria-label="GentiGarage — Ballina" className="shrink-0">
          <img src={logoAsset} alt="GentiGarage Auto Detailing Service" className="h-14 w-auto object-contain md:h-16" />
        </a>
...
<<<<<<< HEAD
        <h1 className="max-w-6xl font-display text-[clamp(3rem,9vw,7rem)] uppercase leading-[.88] text-foreground"><span className="kinetic-rise block">Përsosmëri në</span><span className="kinetic-rise block text-primary">Çdo Detaj</span></h1>
=======
...
>>>>>>> a3cfb111171a714210b4a01af5e1a9313906ff76
...
<<<<<<< HEAD
<section id="book" className="border-b border-border">
  <div className="mx-auto grid max-w-[1400px] gap-12 px-5 py-20 md:grid-cols-12">

    <div id="contact" className="md:col-span-4">
      <Eyebrow text="(h) Rezervim / Kontakt"/>

      <h2 className="mt-3 font-display text-4xl uppercase leading-none md:text-6xl">
        Rezervo<br/>vendin tënd
      </h2>

      <p className="mt-5 text-muted-foreground">
        Dërgo kërkesën dhe GentiGarage do të të kontaktojë për konfirmim.
      </p>
      ...
      <div className="mt-8 space-y-4 text-sm text-muted-foreground">
        ...
        {/* TELEFONI */}
        <p>
          <strong className="text-foreground">Telefoni</strong>
          <br/>
          <a
            href="tel:+38349184032"
        ...
        {/* INSTAGRAM / WHATSAPP */}
        <p>
          <strong className="text-foreground">Instagram / WhatsApp</strong>
          <br/>

          <a
            href="https://www.instagram.com/gentigarage/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-primary transition-colors"
          >
            Instagram: @gentigarage
          </a>

          <br/>

          <a
            href="https://api.whatsapp.com/send/?phone=38349184032&text&type=phone_number&app_absent=0"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-primary transition-colors"
          >
            WhatsApp: +383 49 184 032
          </a>
        </p>

        {/* LOKACIONI */}
        <p>
          <strong className="text-foreground">Lokacioni</strong>
          <br/>
          <a
            href="https://www.google.com/maps?q=M3JJ+XGJ+Genti+Garage,+R220,+Kastriot"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-primary transition-colors"
          >
            GentiGarage — Kastriot
          </a>
        </p>

        {/* ORARI */}
        <p>
          <strong className="text-foreground">Orari i punës</strong>
          <br/>
          Hënë–Shtunë · 09:00–18:00
        </p>
    ...
    <form
      onSubmit={submit}
      className="grid gap-4 md:col-span-8 md:grid-cols-2"
    >
      {([
        {label:"Emri dhe Mbiemri",type:"text"},
        {label:"Numri i telefonit",type:"tel"},
        {label:"Marka e veturës",type:"text"},
        {label:"Modeli",type:"text"},
        {label:"Data e preferuar",type:"date"},
        {label:"Ora e preferuar",type:"time"}
      ]).map((field)=>
        <Field
          key={field.label}
          label={field.label}
      ...
      <label className="flex flex-col gap-2 md:col-span-2">
        ...
        <textarea
          rows={4}
          className="resize-none border border-border bg-card px-4 py-3 text-sm outline-none focus:border-primary"
          placeholder="Na tregoni më shumë për veturën..."
        />
      </label>

      <button className="inline-flex items-center justify-center gap-3 bg-primary px-6 py-4 font-mono text-xs font-bold uppercase text-primary-foreground md:col-span-2">
        {submitted ? "Kërkesa u pranua" : "Dërgo kërkesën"}
        <ArrowRight size={15}/>
      </button>

      {submitted &&
        <p className="text-sm text-primary md:col-span-2">
          Kërkesa u regjistrua në këtë faqe demonstruese.
          Lidhja me sistemin e rezervimeve kërkon shërbimin përkatës.
        </p>
      }
...
<footer className="bg-card">
  <div className="mx-auto grid max-w-[1400px] gap-9 px-5 py-14 md:grid-cols-12">

    {/* LOGO */}
    <div className="md:col-span-5">
      <img
        src={logoAsset}
        alt="GentiGarage Auto Detailing Service"
    ...
    <div className="md:col-span-3">
      ...
      <div className="mt-3 flex flex-wrap gap-4 text-sm text-muted-foreground">
        ...
        <a
          href="https://www.facebook.com/profile.php?id=61558155097472"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-primary transition-colors"
        >
        ...
        <a
          href="https://www.tiktok.com/@gentigarage"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-primary transition-colors"
        >
  ...
  {/* COPYRIGHT */}
  <div className="border-t border-border px-5 py-5 text-center font-mono text-[10px] uppercase text-muted-foreground">
    © 2026 GentiGarage. Të gjitha të drejtat e rezervuara.
  </div>
</footer>
    <div className="fixed bottom-5 right-5 z-40 flex flex-col gap-2"><a href="https://api.whatsapp.com/send/?phone=38349184032&text&type=phone_number&app_absent=0" aria-label="WhatsApp" className="grid size-12 place-items-center rounded-full bg-primary text-primary-foreground"><MessageCircle size={21}/></a><a href="https://www.instagram.com/gentigarage/" aria-label="Instagram" className="grid size-12 place-items-center rounded-full border border-border bg-background text-foreground hover:border-primary hover:text-primary"><Instagram size={20}/></a></div>
=======
